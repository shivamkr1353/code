...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `isverified` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'NO',
...
INSERT INTO `student` (`sid`, `sname`, `semail`, `spass`, `collegename`, `age`, `city`, `gender`, `smobileno`, `isverified`, `dname`, `passingyear`, `result10`, `result12`, `avgcgpa`, `backlogs`) VALUES
...
-- --------------------------------------------------------
ALTER TABLE student ADD COLUMN resume_url VARCHAR(255) NULL;
--
-- Table structure for table `tpo`
--

ALTER TABLE student
ADD COLUMN is_placed TINYINT(1) NOT NULL DEFAULT 0;
...
CREATE TABLE IF NOT EXISTS `tpo` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
;
